...
describe('Engine: custom cache keys', () => {
  ...
  beforeEach(() => {
    demographicSpy.resetHistory()
    demographicDataSpy.resetHistory()
    ...
    let demographicsFact = new AR.Fact('demographics', demographicsDefinition)
    let demographicsDataFact = new AR.Fact('demographic-data', demographicsDataDefinition)
